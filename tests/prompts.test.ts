...
describe('getSystemPrompt', () => {
  ...
  // locales (07/10 is 7 Oct or 10 Jul). The prompt must make the model disambiguate
  // before it parses a birth date into a tool call, or global users get the wrong chart.
